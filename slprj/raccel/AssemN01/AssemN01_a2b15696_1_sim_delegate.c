...
void AssemN01_a2b15696_1_resetSimStateVector ( const void * mech , double *
...
} void AssemN01_a2b15696_1_constructStateVector ( const void * mech , const
double * solverState , const double * u , const double * uDot , double *
discreteState , double * fullState ) { ( void ) mech ; ( void ) discreteState
; fullState [ 0 ] = u [ 0 ] ; fullState [ 1 ] = uDot [ 0 ] ; fullState [ 2 ]
= u [ 1 ] ; fullState [ 3 ] = uDot [ 1 ] ; fullState [ 4 ] = u [ 2 ] ;
fullState [ 5 ] = uDot [ 2 ] ; fullState [ 6 ] = solverState [ 0 ] ;
fullState [ 7 ] = solverState [ 1 ] ; } void
...
] = fullState [ 6 ] ; solverState [ 1 ] = fullState [ 7 ] ; } boolean_T
...
AssemN01_a2b15696_1_isVelocityViolation ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const int * eqnEnableFlags , const double
* state , const int * modeVector ) { const double * rtdvd = rtdv -> mDoubles
. mValues ; const int * rtdvi = rtdv -> mInts . mValues ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) state ; (
void ) modeVector ; return 0 ; } PmfMessageId
AssemN01_a2b15696_1_projectStateSim ( const void * mech , const
...
void AssemN01_a2b15696_1_computeConstraintError ( const void * mech , const
...
) error ; } void AssemN01_a2b15696_1_resetModeVector ( const void * mech ,
int * modeVector ) { ( void ) mech ; ( void ) modeVector ; } boolean_T
AssemN01_a2b15696_1_hasJointDisToNormModeChange ( const void * mech , const
...
; return NULL ; } void AssemN01_a2b15696_1_onModeChangedCutJoints ( const

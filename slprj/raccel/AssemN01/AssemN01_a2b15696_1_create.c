...
) ; extern const NeAssertData AssemN01_a2b15696_1_assertData [ ] ; extern
const NeZCData AssemN01_a2b15696_1_ZCData [ ] ; void
AssemN01_a2b15696_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
AssemN01_a2b15696_1_validateRuntimeParameters ( const double *
runtimeParameters , int32_T * assertSatisfactionFlags ) ; void
AssemN01_a2b15696_1_computeAsmRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void AssemN01_a2b15696_1_computeSimRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
...
double * , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
AssemN01_a2b15696_1_checkDynamics ( const RuntimeDerivedValuesBundle * ,
const double * , const double * , const double * , const double * , const
double * , const int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId AssemN01_a2b15696_1_compOutputsDyn ( const
RuntimeDerivedValuesBundle * , const int * , const double * , const int * ,
const double * , const double * , const double * , const double * , double *
, double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId AssemN01_a2b15696_1_compOutputsKin ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
AssemN01_a2b15696_1_compOutputs ( const RuntimeDerivedValuesBundle * , const
double * , const int * , const double * , const double * , const double * ,
const double * , double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
AssemN01_a2b15696_1_computeAsmModeVector ( const double * , const double * ,
const double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId AssemN01_a2b15696_1_computeSimModeVector ( const double * ,
const double * , const double * , int * , double * , NeuDiagnosticManager *
neDiagMgr ) ; PmfMessageId AssemN01_a2b15696_1_computeZeroCrossings ( const
RuntimeDerivedValuesBundle * , const double * , const double * , const double
* , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; void AssemN01_a2b15696_1_setTargets (
const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , CTarget *
targets ) ; void AssemN01_a2b15696_1_resetAsmStateVector ( const void * mech
, double * stateVector ) ; void AssemN01_a2b15696_1_resetSimStateVector (
...
AssemN01_a2b15696_1_computeDiscreteState ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , double *
stateVector ) ; void AssemN01_a2b15696_1_adjustPosition ( const void * mech ,
...
error ) ; size_t AssemN01_a2b15696_1_computeAssemblyJacobian ( const void *
...
) ; size_t AssemN01_a2b15696_1_computeFullAssemblyJacobian ( const void *
...
double * J ) ; boolean_T AssemN01_a2b15696_1_isInKinematicSingularity ( const
...
void AssemN01_a2b15696_1_convertStateVector ( const void * asmMech , const
...
AssemN01_a2b15696_1_constructStateVector ( const void * mech , const double *
solverStateVector , const double * u , const double * uDot , const double *
discreteStateVector , double * fullStateVector ) ; void
AssemN01_a2b15696_1_extractSolverStateVector ( const void * mech , const
double * fullStateVector , double * solverStateVector ) ; boolean_T
AssemN01_a2b15696_1_isPositionViolation ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , const int *
constraintEqnEnableFlags , const double * stateVector , const int *
modeVector ) ; boolean_T AssemN01_a2b15696_1_isVelocityViolation ( const void
...
* modeVector ) ; PmfMessageId AssemN01_a2b15696_1_projectStateSim ( const
void * mech , const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ,
const int * constraintEqnEnableFlags , const int * modeVector , double *
stateVector , void * neDiagMgr ) ; void
AssemN01_a2b15696_1_computeConstraintError ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , const double *
stateVector , const int * modeVector , double * error ) ; void
AssemN01_a2b15696_1_resetModeVector ( const void * mech , int * modeVector )
; boolean_T AssemN01_a2b15696_1_hasJointDisToNormModeChange ( const void *
mech , const int * prevModeVector , const int * modeVector ) ; PmfMessageId
AssemN01_a2b15696_1_performJointDisToNormModeChange ( const void * mech ,
...
neDiagMgr ) ; void AssemN01_a2b15696_1_onModeChangedCutJoints ( const void *
mech , const int * prevModeVector , const int * modeVector , double *
stateVector ) ; PmfMessageId AssemN01_a2b15696_1_assemble ( const double * u
...
return ; AssemN01_a2b15696_1_computeRuntimeParameters ( runtimeRootVariables
, smData -> mRuntimeParameterScalars . mX ) ;
AssemN01_a2b15696_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
AssemN01_a2b15696_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
...
; AssemN01_a2b15696_1_validateRuntimeParameters ( runtimeParams ,
...
AssemN01_a2b15696_1_compDerivs ( & smData -> mSimRuntimeDerivedValuesBundle ,
...
errorResult = 0.0 ; errorId = AssemN01_a2b15696_1_numJacPerturbLoBounds ( &
...
AssemN01_a2b15696_1_numJacPerturbHiBounds ( & smData ->
...
-> mPrivateData ; errorId = AssemN01_a2b15696_1_compOutputs ( & smData ->
...
errorId = AssemN01_a2b15696_1_computeSimModeVector ( systemInput -> mU . mX ,
...
AssemN01_a2b15696_1_computeZeroCrossings ( & smData ->
...
AssemN01_a2b15696_1_checkDynamics ( & smData ->
mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX , systemInput -> mU .
mX , systemInput -> mU . mX + 3 , systemInput -> mV . mX + 3 , systemInput ->
...
AssemN01_a2b15696_1_computeSimModeVector ( systemInput -> mU . mX ,
...
AssemN01_a2b15696_1_computeAsmModeVector ( systemInput -> mU . mX ,
...
#if 0
AssemN01_a2b15696_1_checkTargets ( & smData -> mSimRuntimeDerivedValuesBundle
...
mOutputVectorSize = 3 ; smData -> mNumConstraintEqns = 0 ; for ( i = 0 ; i <
4 ; ++ i ) smData -> mChecksum [ i ] = 0 ; } static void initStateVector (
NeDaePrivateData * smData ) { PmAllocator * alloc = pm_default_allocator ( )
; const int32_T stateVectorMap [ 2 ] = { 6 , 7 } ; const CTarget targets [ 14
] = { { 0 , 60 , 0 , false , 0 , 1 , "deg" , false , true , +
1.000000000000000000e+00 , false , 1 , { - 3.140413006079461056e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 60 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 61 , 0 , false , 0 , 1 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 3.300515026534863589e-02
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 61 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 62 , 0 , false , 0 , 1 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 1.153478361541687286e-01
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 62 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 63 , 0 , false , 0 , 1 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 1.483529864195121950e-01
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 63 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
...
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 61 , 0 , false , 0 , 3 , "" , false ,
false , + 1.000000000000000000e+00 , false , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 61 , 0
, false , 0 , 3 , "" , true , false , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 62 , 0 , false , 0 , 3 , "" , false ,
false , + 1.000000000000000000e+00 , false , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 62 , 0
, false , 0 , 3 , "" , true , false , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } } ; const size_t numTargets = 14 ; int_T status
...
AssemN01_a2b15696_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
AssemN01_a2b15696_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
[ 2 ] = { "Revolute3.Rz.q" , "Revolute3.Rz.w" } ; const char * varObjects [ 2
] = { "AssemN01/Revolute3" , "AssemN01/Revolute3" } ; smData ->
mNumVarScalars = 2 ; smData -> mVarFullPaths = NULL ; smData -> mVarObjects =
NULL ; if ( smData -> mNumVarScalars > 0 ) { size_t s ; PmAllocator * alloc =
pm_default_allocator ( ) ; PM_ALLOCATE_ARRAY ( smData -> mVarFullPaths ,
PmCharVector , 2 , alloc ) ; PM_ALLOCATE_ARRAY ( smData -> mVarObjects ,
PmCharVector , 2 , alloc ) ; for ( s = 0 ; s < smData -> mNumVarScalars ; ++
...
= { "Revolute.qi" , "Revolute1.qi" , "Revolute2.qi" } ; const char *
inputUnits [ 3 ] = { "rad" , "rad" , "rad" } ; const SizePair inputDimensions
[ 3 ] = { { 1 , 1 } , { 1 , 1 } , { 1 , 1 } } ; const char * outputPortPaths
[ 3 ] = { "Transform_Sensor.x" , "Transform_Sensor.y" , "Transform_Sensor.z"
} ; const char * outputUnits [ 3 ] = { "m" , "m" , "m" } ; const SizePair
outputDimensions [ 3 ] = { { 1 , 1 } , { 1 , 1 } , { 1 , 1 } } ;
initIoInfoHelper ( 3 , inputPortPaths , inputUnits , inputDimensions , true ,
smData ) ; initIoInfoHelper ( 3 , outputPortPaths , outputUnits ,
outputDimensions , false , smData ) ; } static void initInputDerivs (
NeDaePrivateData * smData ) { const int32_T numInputDerivs [ 3 ] = { 2 , 2 ,
2 } ; PmAllocator * alloc = pm_default_allocator ( ) ; const int_T status =
...
smData ) { const boolean_T directFeedthroughVector [ 3 ] = { true , true ,
true } ; const boolean_T directFeedthroughMatrix [ 18 ] = { true , true ,
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true , true } ; PmAllocator * alloc =
...
smData -> mDirectFeedthroughMatrix , 18 , alloc ) ; checkMemAllocStatus (
status ) ; memcpy ( smData -> mDirectFeedthroughMatrix . mX ,
directFeedthroughMatrix , 18 * sizeof ( boolean_T ) ) ; } } static void
...
jointToStageIdx [ 4 ] = { { 60 , 0 } , { 61 , 1 } , { 62 , 2 } , { 63 , 3 } }
...
0.0 ) ; sm_core_SmRealVector_create ( & scratchpad -> mMotionData , 66 , 0.0
) ; delegate -> mSetTargets = AssemN01_a2b15696_1_setTargets ; delegate ->
mResetStateVector = AssemN01_a2b15696_1_resetAsmStateVector ; delegate ->
mInitializeTrackedAngleState =
AssemN01_a2b15696_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = AssemN01_a2b15696_1_computeDiscreteState ; delegate
-> mAdjustPosition = AssemN01_a2b15696_1_adjustPosition ; delegate ->
mPerturbJointPrimitiveState =
AssemN01_a2b15696_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
AssemN01_a2b15696_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix = AssemN01_a2b15696_1_computeVelDofBlendMatrix ;
delegate -> mProjectPartiallyTargetedPos =
AssemN01_a2b15696_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = AssemN01_a2b15696_1_propagateMotion ; delegate ->
mComputeAssemblyError = AssemN01_a2b15696_1_computeAssemblyError ; delegate
-> mComputeAssemblyJacobian = AssemN01_a2b15696_1_computeAssemblyJacobian ;
delegate -> mComputeFullAssemblyJacobian =
AssemN01_a2b15696_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity = AssemN01_a2b15696_1_isInKinematicSingularity ;
delegate -> mConvertStateVector = AssemN01_a2b15696_1_convertStateVector ;
...
= NULL ; const SmSizePair jointToStageIdx [ 4 ] = { { 60 , 0 } , { 61 , 1 } ,
{ 62 , 2 } , { 63 , 3 } } ; const size_t primitiveIndices [ 4 + 1 ] = { 0 , 1
...
AssemN01_a2b15696_1_resetSimStateVector ; delegate ->
mInitializeTrackedAngleState = NULL ; delegate -> mComputeDiscreteState =
NULL ; delegate -> mAdjustPosition = NULL ; delegate ->
mPerturbJointPrimitiveState =
AssemN01_a2b15696_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = AssemN01_a2b15696_1_perturbFlexibleBodyState ;
...
delegate -> mConstructStateVector = AssemN01_a2b15696_1_constructStateVector
; delegate -> mExtractSolverStateVector =
AssemN01_a2b15696_1_extractSolverStateVector ; delegate ->
mIsPositionViolation = AssemN01_a2b15696_1_isPositionViolation ; delegate ->
mIsVelocityViolation = AssemN01_a2b15696_1_isVelocityViolation ; delegate ->
mProjectStateSim = AssemN01_a2b15696_1_projectStateSim ; delegate ->
mComputeConstraintError = AssemN01_a2b15696_1_computeConstraintError ;
delegate -> mResetModeVector = AssemN01_a2b15696_1_resetModeVector ; delegate
-> mHasJointDisToNormModeChange =
AssemN01_a2b15696_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
AssemN01_a2b15696_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = AssemN01_a2b15696_1_onModeChangedCutJoints ;
...
} void AssemN01_a2b15696_1_NeDaePrivateData_create ( NeDaePrivateData *

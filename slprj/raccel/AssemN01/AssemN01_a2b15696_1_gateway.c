...
#endif
#include "nesl_rtw.h"
#include "AssemN01_a2b15696_1.h"
#include "AssemN01_a2b15696_1_gateway.h"
void AssemN01_a2b15696_1_gateway ( void ) { NeModelParameters modelparams = {
( NeSolverType ) 0 , 0.001 , 1 , 0 , 0.001 , 0 , 0 , 0 , 0 , (
SscLoggingSetting ) 0 , 604975784 , } ; NeSolverParameters solverparams = { 0
...
sizeof ( outputparameters_init [ 0 ] ) ; } AssemN01_a2b15696_1_dae ( & dae ,
& modelparams , & solverparams ) ; nesl_register_simulator_group (
"AssemN01/Solver Configuration_1" , 1 , & dae , & solverparams , &

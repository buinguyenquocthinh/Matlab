...
( char_T * ) ( & rtB . lzwt2usxcl [ 0 ] ) , 0 , 0 , 24 } , { ( char_T * ) ( &
rtDW . mezpr2htyz [ 0 ] ) , 0 , 0 , 8 } , { ( char_T * ) ( & rtDW .
ahryi4nzas . TimePtr ) , 11 , 0 , 11 } , { ( char_T * ) ( & rtDW . oe4icidrdp
. PrevIndex ) , 10 , 0 , 3 } , { ( char_T * ) ( & rtDW . dsxvvob5pl ) , 8 , 0
, 2 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . FromWorkspace_Time0 [ 0 ] ) , 0 , 0 , 72080 } } ; static
